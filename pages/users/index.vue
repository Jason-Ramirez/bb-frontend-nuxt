    ...
    <div class="container max-w-7xl mx-auto mt-8">
      <div class="mb-4">
        <div class="flex justify-end">
          <nuxt-link to="/users/create" class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">New User</nuxt-link>
        </div>
      </div>
            ...
            <table class="min-w-full">
              ...
              <tbody class="bg-white">
                <tr>
                  ...
                  <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                    <div class="text-sm leading-5 text-gray-900">Create CURD with tailwind v3</div>
                  </td>
                  <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
